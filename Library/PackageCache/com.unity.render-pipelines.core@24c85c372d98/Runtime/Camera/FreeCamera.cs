...
namespace UnityEngine.Rendering
{
    ...
    public class FreeCamera : MonoBehaviour
    {
        ...
        private bool rotationConfirmed = false;
        ...
        void Update()
        {
            ...
            bool rotated = (rotationConfirmed) && (inputRotateAxisX != 0.0f || inputRotateAxisY != 0.0f);
            if (rotated)
            {
        ...
        public void OnCameraRotateConfirm(InputValue value)
        {
            if (value.isPressed)
            {
