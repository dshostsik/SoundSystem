...
namespace UnityEngine.Rendering
{
    ...
    public class FreeCamera : MonoBehaviour
    {
        ...
        /// <summary>
        /// Field stating if user is holding MMB
        /// </summary>
        private bool moveConfirmed = false;
        ...
        void Update()
        {
            ...
            bool moved =  inputVertical != 0.0f || inputHorizontal != 0.0f || inputYAxis != 0.0f;
            if (moved)
            {
            ...
            // Check if rotation happened. Separate rotation logic from movement logic
            bool rotated = moveConfirmed && (inputRotateAxisX != 0.0f || inputRotateAxisY != 0.0f);
            if (rotated)
            {
